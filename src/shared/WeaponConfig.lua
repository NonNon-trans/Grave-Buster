...
WeaponConfig.Weapons = {
	BASEBALL_BAT = {
		DisplayName = "BASEBALL BAT", IconGlyph = "BAT", BaseDamage = 10, Interval = 0.34, Shape = "Box", Range = 10, Width = 8, Height = 7,
		MaxTargets = 6, HorizontalKnockback = 68, VerticalKnockback = 30, Spin = 7,
		PresentationLifetime = 2.0,
	},
	FRYING_PAN = {
		DisplayName = "FRYING PAN", IconGlyph = "PAN", BaseDamage = 15, Interval = 0.38, Shape = "Box", Range = 9, Width = 13, Height = 7,
		MaxTargets = 8, HorizontalKnockback = 60, VerticalKnockback = 24, Spin = 12,
		PresentationLifetime = 2.0,
	},
	GIANT_HAMMER = {
		DisplayName = "GIANT HAMMER", IconGlyph = "HAM", BaseDamage = 25, Interval = 0.55, Shape = "Radius", Range = 9, Width = 15, Height = 8,
		MaxTargets = 10, HorizontalKnockback = 74, VerticalKnockback = 48, Spin = 8,
		PresentationLifetime = 2.4,
	},
	BLOWER = {
		DisplayName = "BLOWER", IconGlyph = "WND", BaseDamage = 18, Interval = 0.28, Shape = "Cone", Range = 17, Width = 16, Height = 8,
		MaxTargets = 12, HorizontalKnockback = 80, VerticalKnockback = 18, Spin = 4,
		PresentationLifetime = 1.8, MinForwardDot = 0.45,
	},
	THUNDER_ROD = {
		DisplayName = "THUNDER ROD", IconGlyph = "ZAP", BaseDamage = 30, Interval = 0.42, Shape = "Chain", Range = 11, Width = 8, Height = 8,
...
function WeaponConfig.Validate(): boolean
	for _, name in WeaponConfig.Order do
		...
		assert(weapon.BaseDamage > 0 and weapon.BaseDamage % 1 == 0)
